...
![Tools Discovered](screenshots/02-configuration/ss-10-tools-discovered.png)
...
### Reinstalling mcp-kali-server

If you face issues, remove and reinstall cleanly:

```bash
sudo apt remove mcp-kali-server
sudo apt install mcp-kali-server
```
...
![Remove and Reinstall](screenshots/troubleshooting/ss-11-remove.png)

---

## 🎯 Key Takeaways

- `mcp-kali-server` ships natively with Kali Linux — no complex setup needed
- MCP enables Claude to call real security tools without manual command execution
- AI-assisted recon dramatically speeds up vulnerability identification
- PortSwigger labs provide production-realistic attack surfaces for safe practice

---

## 👤 Author

**Shyam Vaderiya (Blade)**  
BTech CSE | Poornima University | Graduating 2027  
🎯 TryHackMe: Top 3% Global  
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-blue)](YOUR_LINKEDIN_URL)
[![TryHackMe](https://img.shields.io/badge/TryHackMe-Top3%25-red)](YOUR_THM_URL)
